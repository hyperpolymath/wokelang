...
// Replace wokelang, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= wokelang — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining wokelang for
...
* Upstream: https://github.com/hyperpolymath/wokelang/issues
