...
WokeLang aims to be a programming language that prioritizes: - *Human
readability* over machine optimization - *Explicit consent* for
sensitive operations - *Gratitude and attribution* as first-class
concepts - *Emotional context* through emote annotations - *Safety by
default* with gentle error handling
...
* link:spec/language.md[Language Specification]
* link:wiki/Home.md[Wiki Home]
* link:api/README.md[API Reference]
* link:tutorials/README.md[Tutorials]
