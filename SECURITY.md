...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/wokelang/security/advisories/new)
...
If you cannot use GitHub Security Advisories, please open a private security report through [GitHub's private vulnerability reporting](https://github.com/hyperpolymath/wokelang/security/advisories/new).
...
- This repository (`hyperpolymath/wokelang`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/wokelang/security/advisories)
...
When using WokeLang, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/wokelang/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/wokelang/security/advisories/new) |
...
*Thank you for helping keep WokeLang and its users safe.* 🛡️
